...
internal class AzureApplicationInsightsProvisioner(Logger<AzureApplicationInsightsProvisioner> logger) : AzureResourceProvisioner<AzureApplicationInsightsResource>
{
    ...
    public override async Task GetOrCreateResourceAsync(
        AzureApplicationInsightsResource resource,
