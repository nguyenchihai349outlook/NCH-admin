...
public class HttpServiceEndPointResolver(ServiceEndPointResolverFactory resolverFactory, IServiceEndPointSelectorProvider selectorProvider, TimeProvider timeProvider) : IAsyncDisposable
{
    ...
    {
        private readonly CompositeServiceEndPointResolver _resolver;
        ...
        public ResolverEntry(CompositeServiceEndPointResolver resolver, IServiceEndPointSelector selector)
        {
            _resolver = resolver;
            _selector = selector;
