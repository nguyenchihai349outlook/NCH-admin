...
public sealed class ServiceEndPointResolver : IAsyncDisposable
{
    ...
    private sealed class ResolverEntry(CompositeServiceEndPointResolver resolver) : IAsyncDisposable
    {
        private readonly CompositeServiceEndPointResolver _resolver = resolver;
