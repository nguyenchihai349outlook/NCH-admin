...
/// </summary>
public sealed partial class CompositeServiceEndPointResolver(
...
{
    private static readonly TimerCallback s_pollingAction = static state => _ = ((CompositeServiceEndPointResolver)state!).RefreshAsync(force: true);
            ...
            try
            {
                ...
                lock (_lock)
                {
                    ...
                    if (endPoints.ChangeToken.ActiveChangeCallbacks)
                    {
                        ...
                        endPoints.ChangeToken.RegisterChangeCallback(static state => _ = ((CompositeServiceEndPointResolver)state!).RefreshAsync(force: false), this);
